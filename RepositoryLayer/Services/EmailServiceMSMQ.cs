    ...
    public class EmailServiceMSMQ
    {
        public static void SendEmail(string email, string token, string Firstname)
        {
            using (SmtpClient client = new SmtpClient("smtp.gmail.com", 587))
            {
                ...
                client.Credentials = new NetworkCredential("testcoding654@gmail.com", "kwrydsizimtqepyu");
                MailMessage msgObj = new MailMessage();
                msgObj.To.Add(email);
                msgObj.IsBodyHtml = true;
                msgObj.From = new MailAddress("testcoding654@gmail.com");
